...
/** @constructor */
function $c_Lhanoi_veze_HanojskeVeze$() {
  $c_O.call(this);
  this.pocetDisku$1 = 0;
  this.sirkaMinDisku$1 = 0;
  this.prirustekSirky$1 = 0;
  this.vyskaDisku$1 = 0;
  this.mezera$1 = 0;
  this.rozmeryCanvas$1 = null;
  this.zapisnik$1 = null;
  this.tycky$1 = null;
  this.prenasenyDisk$1 = null
}
$c_Lhanoi_veze_HanojskeVeze$.prototype = new $h_O();
$c_Lhanoi_veze_HanojskeVeze$.prototype.constructor = $c_Lhanoi_veze_HanojskeVeze$;
/** @constructor */
function $h_Lhanoi_veze_HanojskeVeze$() {
  /*<skip>*/
}
$h_Lhanoi_veze_HanojskeVeze$.prototype = $c_Lhanoi_veze_HanojskeVeze$.prototype;
$c_Lhanoi_veze_HanojskeVeze$.prototype.init___ = (function() {
  $n_Lhanoi_veze_HanojskeVeze$ = this;
  this.pocetDisku$1 = 3;
  this.sirkaMinDisku$1 = 50;
  this.prirustekSirky$1 = 40;
  this.vyskaDisku$1 = 20;
  this.mezera$1 = 3;
  this.rozmeryCanvas$1 = new $c_s_Tuple2$mcII$sp().init___I__I(0, 0);
  this.zapisnik$1 = null;
  var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lhanoi_veze_HanojskeVeze$Tycka().init___(), new $c_Lhanoi_veze_HanojskeVeze$Tycka().init___(), new $c_Lhanoi_veze_HanojskeVeze$Tycka().init___()]);
  var len = $uI(xs.array$6.length);
  var array = $newArrayObject($d_Lhanoi_veze_HanojskeVeze$Tycka.getArrayOf(), [len]);
  var elem$1 = 0;
  elem$1 = 0;
  ...
  this.tycky$1 = array;
  this.prenasenyDisk$1 = new $c_T2().init___O__O((-1), null);
  return this
});
$c_Lhanoi_veze_HanojskeVeze$.prototype.init__V = (function() {
  var elem = ((this.sirkaMinDisku$1 + $imul((((-1) + this.pocetDisku$1) | 0), this.prirustekSirky$1)) | 0);
  var elem$1 = 0;
  elem$1 = elem;
  var xs = this.tycky$1;
  var i = 0;
  ...
  while ((i < len)) {
    var index = i;
    var arg1 = xs.u[index];
    var t = $as_Lhanoi_veze_HanojskeVeze$Tycka(arg1);
    t.vymazDisky__V();
    i = ((1 + i) | 0)
  };
  var end = this.pocetDisku$1;
  var isEmpty$4 = (end <= 0);
  if (isEmpty$4) {
    /*<skip>*/
  };
  ...
  inlinereturn$18: {
    if ((!isEmpty$4)) {
      ...
      while (true) {
        var v1 = i$1;
        $m_Lhanoi_veze_HanojskeVeze$().tycky$1.u[0] = $m_Lhanoi_veze_HanojskeVeze$().tycky$1.u[0].$$plus__Lhanoi_veze_HanojskeVeze$Disk__Lhanoi_veze_HanojskeVeze$Tycka(new $c_Lhanoi_veze_HanojskeVeze$Disk().init___I__T(((elem$1 - $imul(v1, $m_Lhanoi_veze_HanojskeVeze$().prirustekSirky$1)) | 0), $m_Lhanoi_veze_HanojskeVeze$().nahodnaBarva__T()));
        if ((i$1 === lastElement$4)) {
          break inlinereturn$18
        };
        i$1 = ((1 + i$1) | 0)
      }
    }
...
$c_Lhanoi_veze_HanojskeVeze$.prototype.pustDisk__T2__V = (function(pozice) {
  var x = ("pozice: " + pozice);
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V((x + "\n"));
  var x$1 = this.prenasenyDisk$1;
  ...
  if ((this.prenasenyDisk$1.$$und2__O() !== null)) {
    $m_s_package$();
    inlinereturn$14: {
      var i = 0;
      while (true) {
        var v1 = i;
        if (($m_Lhanoi_veze_HanojskeVeze$().tycky$1.u[v1].jsemPod__T2__Z(pozice) && $m_Lhanoi_veze_HanojskeVeze$().tycky$1.u[v1].lzeVlozit__Lhanoi_veze_HanojskeVeze$Disk__Z($as_Lhanoi_veze_HanojskeVeze$Disk($m_Lhanoi_veze_HanojskeVeze$().prenasenyDisk$1.$$und2__O())))) {
          $m_Lhanoi_veze_HanojskeVeze$().tycky$1.u[v1] = $m_Lhanoi_veze_HanojskeVeze$().tycky$1.u[v1].$$plus__Lhanoi_veze_HanojskeVeze$Disk__Lhanoi_veze_HanojskeVeze$Tycka($as_Lhanoi_veze_HanojskeVeze$Disk($m_Lhanoi_veze_HanojskeVeze$().prenasenyDisk$1.$$und2__O()));
          $m_Lhanoi_veze_HanojskeVeze$().zapisnik$1.zapisTah__I__I__V($m_Lhanoi_veze_HanojskeVeze$().prenasenyDisk$1.$$und1$mcI$sp__I(), v1);
          $m_Lhanoi_veze_HanojskeVeze$().prenasenyDisk$1 = new $c_T2().init___O__O((-1), null)
        };
        if ((i === 2)) {
    ...
    if ((this.prenasenyDisk$1.$$und2__O() !== null)) {
      this.tycky$1.u[this.prenasenyDisk$1.$$und1$mcI$sp__I()] = this.tycky$1.u[this.prenasenyDisk$1.$$und1$mcI$sp__I()].$$plus__Lhanoi_veze_HanojskeVeze$Disk__Lhanoi_veze_HanojskeVeze$Tycka($as_Lhanoi_veze_HanojskeVeze$Disk(this.prenasenyDisk$1.$$und2__O()))
    };
    this.prenasenyDisk$1 = new $c_T2().init___O__O((-1), null)
  }
});
$c_Lhanoi_veze_HanojskeVeze$.prototype.nahodnaBarva__T = (function() {
  var r = $m_s_util_Random$();
  $m_sci_List$();
  var b = new $c_scm_ListBuffer().init___();
  var i = 0;
  while ((i < 3)) {
    var elem = r.self$1.nextInt__I__I(255);
    b.$$plus$eq__O__scm_ListBuffer(elem);
    i = ((1 + i) | 0)
  };
  var ba = b.toList__sci_List();
  var f = (function(e$2) {
    var e = $uI(e$2);
    if ((e < 15)) {
      var x = $uD((e >>> 0));
  ...
  if ((bf === $m_sci_List$().ReusableCBFInstance$2)) {
    ...
    var b$1 = $s_sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(ba, bf);
    var these = ba;
    while ((!these.isEmpty__Z())) {
  ...
  return ("#" + $as_sc_TraversableOnce(jsx$3).mkString__T__T(""))
});
$c_Lhanoi_veze_HanojskeVeze$.prototype.$$js$exported$meth$main__Lorg_scalajs_dom_raw_HTMLSelectElement__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_HTMLTextAreaElement__O = (function(pocD, canvas, hist) {
  this.main__Lorg_scalajs_dom_raw_HTMLSelectElement__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_HTMLTextAreaElement__V(pocD, canvas, hist)
});
$c_Lhanoi_veze_HanojskeVeze$.prototype.main__Lorg_scalajs_dom_raw_HTMLSelectElement__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_HTMLTextAreaElement__V = (function(pocD, canvas, hist) {
  var renderer = canvas.getContext("2d");
  this.zapisnik$1 = new $c_Lhanoi_veze_HanojskeVeze$Zapisnik().init___Lorg_scalajs_dom_raw_HTMLTextAreaElement(hist);
  pocD.onchange = (function(pocD$1, hist$1, renderer$1) {
    return (function(e$2) {
      var x = $uI(pocD$1.selectedIndex);
      var this$2 = $m_s_Console$();
      var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
      this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V((x + "\n"));
      $m_Lhanoi_veze_HanojskeVeze$().pocetDisku$1 = ((3 + $uI(pocD$1.selectedIndex)) | 0);
      $m_Lhanoi_veze_HanojskeVeze$().init__V();
      $m_Lhanoi_veze_HanojskeVeze$().initCanvas__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(renderer$1);
      $m_Lhanoi_veze_HanojskeVeze$().zapisnik$1 = new $c_Lhanoi_veze_HanojskeVeze$Zapisnik().init___Lorg_scalajs_dom_raw_HTMLTextAreaElement(hist$1)
    })
  })(pocD, hist, renderer);
  canvas.width = $uI(canvas.parentElement.clientWidth);
  canvas.height = 400;
  this.rozmeryCanvas$1 = new $c_s_Tuple2$mcII$sp().init___I__I($uI(canvas.width), $uI(canvas.height));
  renderer.fillStyle = "#f8f8f8";
  renderer.fillRect(0.0, 0.0, $uI(canvas.width), $uI(canvas.height));
  renderer.fillStyle = "black";
  this.init__V();
  this.tycky$1.u[0].pozice$1 = new $c_s_Tuple2$mcII$sp().init___I__I(300, 100);
  this.tycky$1.u[0].platno$1 = renderer;
  this.tycky$1.u[1].pozice$1 = new $c_s_Tuple2$mcII$sp().init___I__I(600, 100);
  this.tycky$1.u[1].platno$1 = renderer;
  this.tycky$1.u[2].pozice$1 = new $c_s_Tuple2$mcII$sp().init___I__I(900, 100);
  this.tycky$1.u[2].platno$1 = renderer;
  this.initCanvas__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(renderer);
  var stisk = new $c_sr_BooleanRef().init___Z(false);
  canvas.onmousedown = (function(canvas$1, renderer$1$1, stisk$1) {
    return (function(e$2$1) {
      $m_Lhanoi_veze_HanojskeVeze$().naberDisk__T2__V($m_Lhanoi_veze_HanojskeVeze$().hanoi$veze$HanojskeVeze$$pozMys$1__D__D__Lorg_scalajs_dom_raw_HTMLCanvasElement__T2($uD(e$2$1.clientX), $uD(e$2$1.clientY), canvas$1));
      $m_Lhanoi_veze_HanojskeVeze$().initCanvas__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(renderer$1$1);
      stisk$1.elem$1 = true
    })
  })(canvas, renderer, stisk);
  canvas.onmouseup = (function(canvas$1$1, renderer$1$2, stisk$1$1) {
    return (function(e$2$2) {
      $m_Lhanoi_veze_HanojskeVeze$().pustDisk__T2__V($m_Lhanoi_veze_HanojskeVeze$().hanoi$veze$HanojskeVeze$$pozMys$1__D__D__Lorg_scalajs_dom_raw_HTMLCanvasElement__T2($uD(e$2$2.clientX), $uD(e$2$2.clientY), canvas$1$1));
      $m_Lhanoi_veze_HanojskeVeze$().initCanvas__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(renderer$1$2);
      stisk$1$1.elem$1 = false
    })
  })(canvas, renderer, stisk);
  canvas.onmousemove = (function(canvas$1$2, renderer$1$3, stisk$1$2) {
    return (function(e$2$3) {
      canvas$1$2.getBoundingClientRect();
      if ((stisk$1$2.elem$1 && ($m_Lhanoi_veze_HanojskeVeze$().prenasenyDisk$1.$$und2__O() !== null))) {
        $m_Lhanoi_veze_HanojskeVeze$().initCanvas__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(renderer$1$3);
        $as_Lhanoi_veze_HanojskeVeze$Disk($m_Lhanoi_veze_HanojskeVeze$().prenasenyDisk$1.$$und2__O()).nakresliSe__T2__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V($m_Lhanoi_veze_HanojskeVeze$().hanoi$veze$HanojskeVeze$$pozMys$1__D__D__Lorg_scalajs_dom_raw_HTMLCanvasElement__T2($uD(e$2$3.clientX), $uD(e$2$3.clientY), canvas$1$2), renderer$1$3)
      }
    })
  })(canvas, renderer, stisk)
});
$c_Lhanoi_veze_HanojskeVeze$.prototype.hanoi$veze$HanojskeVeze$$pozMys$1__D__D__Lorg_scalajs_dom_raw_HTMLCanvasElement__T2 = (function(x, y, canvas$1) {
  var rect = canvas$1.getBoundingClientRect();
  return new $c_s_Tuple2$mcII$sp().init___I__I($doubleToInt((x - $uD(rect.left))), $doubleToInt((y - $uD(rect.top))))
});
$c_Lhanoi_veze_HanojskeVeze$.prototype.initCanvas__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(kam) {
  kam.clearRect(0.0, 0.0, this.rozmeryCanvas$1.$$und1$mcI$sp__I(), this.rozmeryCanvas$1.$$und2$mcI$sp__I());
  $m_s_package$();
  inlinereturn$6: {
    var i = 0;
    while (true) {
      var v1 = i;
      $m_Lhanoi_veze_HanojskeVeze$().tycky$1.u[v1].nakresliSe__V();
      if ((i === 2)) {
...
$c_Lhanoi_veze_HanojskeVeze$.prototype.naberDisk__T2__V = (function(pozice) {
  var x = ("pozice: " + pozice);
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V((x + "\n"));
  ...
  inlinereturn$10: {
    ...
    while (true) {
      var v1 = i;
      if ($m_Lhanoi_veze_HanojskeVeze$().tycky$1.u[v1].jsemPod__T2__Z(pozice)) {
        $m_Lhanoi_veze_HanojskeVeze$().prenasenyDisk$1 = new $c_T2().init___O__O(v1, $m_Lhanoi_veze_HanojskeVeze$().tycky$1.u[v1].pop__Lhanoi_veze_HanojskeVeze$Disk());
        var x$1 = ("nasel se" + v1);
      ...
      if ((i === 2)) {
        break inlinereturn$10
      };
      i = ((1 + i) | 0)
    }
  };
  var x$2 = this.prenasenyDisk$1;
...
$c_Lhanoi_veze_HanojskeVeze$.prototype.main = (function(arg$1, arg$2, arg$3) {
  var prep0 = arg$1;
  var prep1 = arg$2;
  var prep2 = arg$3;
  return this.$$js$exported$meth$main__Lorg_scalajs_dom_raw_HTMLSelectElement__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_HTMLTextAreaElement__O(prep0, prep1, prep2)
});
var $d_Lhanoi_veze_HanojskeVeze$ = new $TypeData().initClass({
  Lhanoi_veze_HanojskeVeze$: 0
}, false, "hanoi.veze.HanojskeVeze$", {
  Lhanoi_veze_HanojskeVeze$: 1,
  O: 1
});
$c_Lhanoi_veze_HanojskeVeze$.prototype.$classData = $d_Lhanoi_veze_HanojskeVeze$;
var $n_Lhanoi_veze_HanojskeVeze$ = (void 0);
function $m_Lhanoi_veze_HanojskeVeze$() {
  if ((!$n_Lhanoi_veze_HanojskeVeze$)) {
    $n_Lhanoi_veze_HanojskeVeze$ = new $c_Lhanoi_veze_HanojskeVeze$().init___()
  };
  return $n_Lhanoi_veze_HanojskeVeze$
}
$e.hanoi = ($e.hanoi || {});
$e.hanoi.veze = ($e.hanoi.veze || {});
$e.hanoi.veze.HanojskeVeze = $m_Lhanoi_veze_HanojskeVeze$;
/** @constructor */
function $c_Lhanoi_veze_HanojskeVeze$Tycka() {
  $c_O.call(this);
  this.disky$1 = null;
  this.pozice$1 = null;
  this.platno$1 = null;
  this.delkaTycky$1 = 0;
  this.horniMezera$1 = 0
}
$c_Lhanoi_veze_HanojskeVeze$Tycka.prototype = new $h_O();
$c_Lhanoi_veze_HanojskeVeze$Tycka.prototype.constructor = $c_Lhanoi_veze_HanojskeVeze$Tycka;
/** @constructor */
function $h_Lhanoi_veze_HanojskeVeze$Tycka() {
  /*<skip>*/
}
$h_Lhanoi_veze_HanojskeVeze$Tycka.prototype = $c_Lhanoi_veze_HanojskeVeze$Tycka.prototype;
$c_Lhanoi_veze_HanojskeVeze$Tycka.prototype.init___ = (function() {
  this.disky$1 = $m_sci_Nil$();
  this.delkaTycky$1 = 0;
  this.horniMezera$1 = 0;
  this.vymazDisky__V();
  return this
});
$c_Lhanoi_veze_HanojskeVeze$Tycka.prototype.kresliDisky$1__p1__I__sci_List__V = (function(yp, t) {
  x: {
    _kresliDisky: while (true) {
      var x1 = t;
      matchEnd5: {
        $m_sci_List$();
        var o8 = new $c_s_Some().init___O(x1);
        if ((o8.x$2 !== null)) {
          var this$2 = $as_sc_LinearSeqOptimized(o8.x$2);
          var jsx$1 = ($s_sc_LinearSeqOptimized$class__lengthCompare__sc_LinearSeqOptimized__I__I(this$2, 0) === 0)
        } else {
          var jsx$1 = false
        };
        if (jsx$1) {
        ...
        if ($is_sci_$colon$colon(x1)) {
          ...
          var prvni = $as_Lhanoi_veze_HanojskeVeze$Disk(x3.head$5);
          var zbytek = x3.tl$5;
          var x = ("kreslim disk barvy..." + prvni.barva$1);
          ...
          var _1$mcI$sp = this.pozice$1.$$und1$mcI$sp__I();
          var _2$mcI$sp = yp;
          var kam = this.platno$1;
          var s = prvni.barva$1;
          kam.fillStyle = s;
          kam.fillRect(((_1$mcI$sp - ((prvni.sirka$1 / 2) | 0)) | 0), _2$mcI$sp, prvni.sirka$1, $m_Lhanoi_veze_HanojskeVeze$().vyskaDisku$1);
          var temp$yp = ((((yp + $m_Lhanoi_veze_HanojskeVeze$().vyskaDisku$1) | 0) + $m_Lhanoi_veze_HanojskeVeze$().mezera$1) | 0);
          yp = temp$yp;
          t = zbytek;
          continue _kresliDisky
        };
        throw new $c_s_MatchError().init___O(x1)
      };
      break x
...
$c_Lhanoi_veze_HanojskeVeze$Tycka.prototype.vymazDisky__V = (function() {
  this.delkaTycky$1 = (($imul($m_Lhanoi_veze_HanojskeVeze$().pocetDisku$1, (($m_Lhanoi_veze_HanojskeVeze$().vyskaDisku$1 + $m_Lhanoi_veze_HanojskeVeze$().mezera$1) | 0)) + $imul(2, $m_Lhanoi_veze_HanojskeVeze$().mezera$1)) | 0);
  this.disky$1 = $m_sci_Nil$();
  this.horniMezera$1 = this.delkaTycky$1
});
$c_Lhanoi_veze_HanojskeVeze$Tycka.prototype.lzeVlozit__Lhanoi_veze_HanojskeVeze$Disk__Z = (function(d) {
  return (this.disky$1.isEmpty__Z() || ($as_Lhanoi_veze_HanojskeVeze$Disk(this.disky$1.head__O()).sirka$1 > d.sirka$1))
});
$c_Lhanoi_veze_HanojskeVeze$Tycka.prototype.$$plus__Lhanoi_veze_HanojskeVeze$Disk__Lhanoi_veze_HanojskeVeze$Tycka = (function(ds) {
  if (this.lzeVlozit__Lhanoi_veze_HanojskeVeze$Disk__Z(ds)) {
    var this$1 = this.disky$1;
    this.disky$1 = new $c_sci_$colon$colon().init___O__sci_List(ds, this$1);
    this.horniMezera$1 = ((this.horniMezera$1 - (($m_Lhanoi_veze_HanojskeVeze$().vyskaDisku$1 + $m_Lhanoi_veze_HanojskeVeze$().mezera$1) | 0)) | 0)
  };
  return this
});
$c_Lhanoi_veze_HanojskeVeze$Tycka.prototype.jsemPod__T2__Z = (function(poz) {
  return ((((((this.pozice$1.$$und1$mcI$sp__I() - (($m_Lhanoi_veze_HanojskeVeze$().sirkaMinDisku$1 / 2) | 0)) | 0) < poz.$$und1$mcI$sp__I()) && (((this.pozice$1.$$und1$mcI$sp__I() + (($m_Lhanoi_veze_HanojskeVeze$().sirkaMinDisku$1 / 2) | 0)) | 0) > poz.$$und1$mcI$sp__I())) && (this.pozice$1.$$und2$mcI$sp__I() < poz.$$und2$mcI$sp__I())) && (((this.pozice$1.$$und2$mcI$sp__I() + this.delkaTycky$1) | 0) > poz.$$und2$mcI$sp__I()))
});
$c_Lhanoi_veze_HanojskeVeze$Tycka.prototype.pop__Lhanoi_veze_HanojskeVeze$Disk = (function() {
  var h = null;
  if ((!this.disky$1.isEmpty__Z())) {
    h = $as_Lhanoi_veze_HanojskeVeze$Disk(this.disky$1.head__O());
    var this$1 = this.disky$1;
    this.disky$1 = this$1.tail__sci_List();
    this.horniMezera$1 = ((this.horniMezera$1 + (($m_Lhanoi_veze_HanojskeVeze$().vyskaDisku$1 + $m_Lhanoi_veze_HanojskeVeze$().mezera$1) | 0)) | 0)
  };
  return h
});
$c_Lhanoi_veze_HanojskeVeze$Tycka.prototype.nakresliSe__V = (function() {
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("kreslim tycku:\n");
  this.platno$1.fillStyle = "red";
  this.platno$1.fillRect(((this.pozice$1.$$und1$mcI$sp__I() - $m_Lhanoi_veze_HanojskeVeze$().mezera$1) | 0), this.pozice$1.$$und2$mcI$sp__I(), $imul(2, $m_Lhanoi_veze_HanojskeVeze$().mezera$1), this.delkaTycky$1);
  this.kresliDisky$1__p1__I__sci_List__V(((this.pozice$1.$$und2$mcI$sp__I() + this.horniMezera$1) | 0), this.disky$1)
});
function $is_Lhanoi_veze_HanojskeVeze$Tycka(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lhanoi_veze_HanojskeVeze$Tycka)))
}
function $as_Lhanoi_veze_HanojskeVeze$Tycka(obj) {
  return (($is_Lhanoi_veze_HanojskeVeze$Tycka(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "hanoi.veze.HanojskeVeze$Tycka"))
}
function $isArrayOf_Lhanoi_veze_HanojskeVeze$Tycka(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lhanoi_veze_HanojskeVeze$Tycka)))
}
function $asArrayOf_Lhanoi_veze_HanojskeVeze$Tycka(obj, depth) {
  return (($isArrayOf_Lhanoi_veze_HanojskeVeze$Tycka(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lhanoi.veze.HanojskeVeze$Tycka;", depth))
}
var $d_Lhanoi_veze_HanojskeVeze$Tycka = new $TypeData().initClass({
  Lhanoi_veze_HanojskeVeze$Tycka: 0
}, false, "hanoi.veze.HanojskeVeze$Tycka", {
  Lhanoi_veze_HanojskeVeze$Tycka: 1,
  O: 1
});
$c_Lhanoi_veze_HanojskeVeze$Tycka.prototype.$classData = $d_Lhanoi_veze_HanojskeVeze$Tycka;
/** @constructor */
...
$c_Ltutorial_webapp_TutorialApp$.prototype.addClickedMessage__V = (function() {
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("body").append("<p>Kliknul jsi!!</p>")
});
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_Lhanoi_veze_HanojskeVeze$Disk() {
  $c_O.call(this);
  this.sirka$1 = 0;
  this.barva$1 = null
}
$c_Lhanoi_veze_HanojskeVeze$Disk.prototype = new $h_O();
$c_Lhanoi_veze_HanojskeVeze$Disk.prototype.constructor = $c_Lhanoi_veze_HanojskeVeze$Disk;
/** @constructor */
function $h_Lhanoi_veze_HanojskeVeze$Disk() {
  /*<skip>*/
}
$h_Lhanoi_veze_HanojskeVeze$Disk.prototype = $c_Lhanoi_veze_HanojskeVeze$Disk.prototype;
$c_Lhanoi_veze_HanojskeVeze$Disk.prototype.productPrefix__T = (function() {
  return "Disk"
});
$c_Lhanoi_veze_HanojskeVeze$Disk.prototype.productArity__I = (function() {
  return 2
});
$c_Lhanoi_veze_HanojskeVeze$Disk.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.sirka$1;
      break
...
$c_Lhanoi_veze_HanojskeVeze$Disk.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lhanoi_veze_HanojskeVeze$Disk.prototype.init___I__T = (function(sirka, barva) {
  this.sirka$1 = sirka;
  this.barva$1 = barva;
  return this
});
$c_Lhanoi_veze_HanojskeVeze$Disk.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.sirka$1);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.barva$1));
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 2)
});
$c_Lhanoi_veze_HanojskeVeze$Disk.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Lhanoi_veze_HanojskeVeze$Disk.prototype.nakresliSe__T2__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(pozice, kam) {
  var s = this.barva$1;
  kam.fillStyle = s;
  kam.fillRect(((pozice.$$und1$mcI$sp__I() - ((this.sirka$1 / 2) | 0)) | 0), pozice.$$und2$mcI$sp__I(), this.sirka$1, $m_Lhanoi_veze_HanojskeVeze$().vyskaDisku$1)
});
function $is_Lhanoi_veze_HanojskeVeze$Disk(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lhanoi_veze_HanojskeVeze$Disk)))
}
function $as_Lhanoi_veze_HanojskeVeze$Disk(obj) {
  return (($is_Lhanoi_veze_HanojskeVeze$Disk(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "hanoi.veze.HanojskeVeze$Disk"))
}
function $isArrayOf_Lhanoi_veze_HanojskeVeze$Disk(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lhanoi_veze_HanojskeVeze$Disk)))
}
function $asArrayOf_Lhanoi_veze_HanojskeVeze$Disk(obj, depth) {
  return (($isArrayOf_Lhanoi_veze_HanojskeVeze$Disk(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lhanoi.veze.HanojskeVeze$Disk;", depth))
}
var $d_Lhanoi_veze_HanojskeVeze$Disk = new $TypeData().initClass({
  Lhanoi_veze_HanojskeVeze$Disk: 0
}, false, "hanoi.veze.HanojskeVeze$Disk", {
  Lhanoi_veze_HanojskeVeze$Disk: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lhanoi_veze_HanojskeVeze$Disk.prototype.$classData = $d_Lhanoi_veze_HanojskeVeze$Disk;
/** @constructor */
function $c_Lhanoi_veze_HanojskeVeze$Zapisnik() {
  $c_O.call(this);
  this.h$1 = null;
  this.pocetTahu$1 = 0
}
$c_Lhanoi_veze_HanojskeVeze$Zapisnik.prototype = new $h_O();
$c_Lhanoi_veze_HanojskeVeze$Zapisnik.prototype.constructor = $c_Lhanoi_veze_HanojskeVeze$Zapisnik;
/** @constructor */
function $h_Lhanoi_veze_HanojskeVeze$Zapisnik() {
  /*<skip>*/
}
$h_Lhanoi_veze_HanojskeVeze$Zapisnik.prototype = $c_Lhanoi_veze_HanojskeVeze$Zapisnik.prototype;
$c_Lhanoi_veze_HanojskeVeze$Zapisnik.prototype.productPrefix__T = (function() {
  return "Zapisnik"
});
$c_Lhanoi_veze_HanojskeVeze$Zapisnik.prototype.productArity__I = (function() {
  return 1
});
$c_Lhanoi_veze_HanojskeVeze$Zapisnik.prototype.zapisTah__I__I__V = (function(od, kam) {
  this.pocetTahu$1 = ((1 + this.pocetTahu$1) | 0);
  this.zapis__T__V((((((this.pocetTahu$1 + ". (") + od) + " -> ") + kam) + ")\n"))
});
$c_Lhanoi_veze_HanojskeVeze$Zapisnik.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.h$1;
      break
...
$c_Lhanoi_veze_HanojskeVeze$Zapisnik.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lhanoi_veze_HanojskeVeze$Zapisnik.prototype.zapis__T__V = (function(jaky) {
  this.h$1.value = (("" + $as_T(this.h$1.value)) + jaky)
});
$c_Lhanoi_veze_HanojskeVeze$Zapisnik.prototype.init___Lorg_scalajs_dom_raw_HTMLTextAreaElement = (function(h) {
  this.h$1 = h;
  this.pocetTahu$1 = 0;
  h.value = "";
  return this
});
$c_Lhanoi_veze_HanojskeVeze$Zapisnik.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lhanoi_veze_HanojskeVeze$Zapisnik.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Lhanoi_veze_HanojskeVeze$Zapisnik = new $TypeData().initClass({
  Lhanoi_veze_HanojskeVeze$Zapisnik: 0
}, false, "hanoi.veze.HanojskeVeze$Zapisnik", {
  Lhanoi_veze_HanojskeVeze$Zapisnik: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lhanoi_veze_HanojskeVeze$Zapisnik.prototype.$classData = $d_Lhanoi_veze_HanojskeVeze$Zapisnik;
/** @constructor */
...
//# sourceMappingURL=scala-js-hanoi-fastopt.js.map
